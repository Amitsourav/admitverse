...
const footerLinks = {
  ...
  resources: [
    ...
    { name: 'Application Tips', href: '/application-tips' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-sm">
              Your gateway to international education. Discover the best universities, 
              courses, and opportunities worldwide with expert guidance.
            </p>
