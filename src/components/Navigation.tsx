          ...
          <div className="hidden md:flex items-center space-x-8">
            {navLinks.map((link) => (
              link.hasDropdown ? (
                ...
                >
                  <button className="flex items-center text-gray-700 hover:text-emerald-600 font-semibold transition-all duration-300 group">
                    {link.label}
                    <motion.div
                      ...
                      >
                        {serviceOptions.map((option, index) => (
                          ...
                          >
                            <Link
                              href={option.href}
                              className="block px-5 py-3 text-gray-700 hover:bg-gradient-to-r hover:from-emerald-50 hover:to-green-50 hover:text-emerald-600 transition-all duration-200 relative group/item"
                            >
                          ...
                          <div className="ml-4 mt-2 space-y-2 pb-2">
                            {serviceOptions.map((option, index) => (
                              ...
                              >
                                <Link
                                  href={option.href}
                                  className="block text-gray-600 hover:text-emerald-600 py-2 pl-4 border-l-2 border-transparent hover:border-emerald-500 transition-all duration-200"
